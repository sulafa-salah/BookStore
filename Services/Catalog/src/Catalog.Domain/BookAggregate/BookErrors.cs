...
namespace Catalog.Domain.BookAggregate;
    ...
    public static readonly Error StockCannotBeNegative = Error.Validation("Book.StockNegative", "Stock cannot be negative.");
    public static readonly Error CannotPublishWithoutStock = Error.Validation("Book.NoStock", "Cannot publish without stock.");
